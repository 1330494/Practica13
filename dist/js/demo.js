...
(function ($) {
  ...
  $container.append(
    '<h5>Personalizar Sitio</h5><hr class="mb-2"/>'
    + '<h6>Estilos de NavBar</h6>'
  )
  ...
  $checkbox_container.append('<span>Borde: Barra de Navegacion.</span>')
  ...
  $container.append('<h6>Panel Lateral: Oscuros</h6>')
  ...
  $container.append('<h6>Panel Lateral: Claro</h6>')
  var $sidebar_variants = $('<div />', {
    'class': 'd-flex'
  })
  $container.append($sidebar_variants)
  ...
  $container.append('<h6>Color Fondo Logo</h6>')
